...
import { userOnly, vendorOnly, vendorOrAdmin, adminOnly } from '../middleware/role.js';
...
router.get('/vendor/revenue', auth, vendorOnly, bookingController.getRevenueByVendor);
router.get('/revenue/:vendorId', auth, adminOnly, bookingController.getRevenueByVendor);
